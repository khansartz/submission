...
with st.expander("Lihat Penjelasan"):
    st.write(
        """Pada tahun 2011, terjadi peningkatan pesat dalam penyewaan sepeda pada bulan Mei, 
        diikuti penurunan yang stabil dari bulan Juni sampai Oktober. Sedangkan, pada tahun 2012, 
        terjadi peningkatan pesat pada bulan Maret, kemudian mengalami kenaikan yang stabil dari 
        bulan April sampai September, serta mengalami penurunan drastis pada bulan November.
        """
    )
...
with st.expander("Lihat Penjelasan"):
    st.write(
        """Rata-rata penyewa sepeda tertinggi terjadi pada musim gugur (fall), 
        dengan lebih dari 4000 orang. Selain itu, kondisi cuaca juga berpengaruh, 
        di mana rata-rata penyewa sepeda saat cuaca cerah mencapai lebih dari 4500 orang.
        """
    )
